...
function checkValues()
{
	...
	fn=document.forms["updateForm"]["fname"].value;
	user=document.forms["updateForm"]["uname"].value;
	pass1=document.forms["updateForm"]["pass"].value;
	pass2=document.forms["updateForm"]["rpass"].value;
	email=document.forms["updateForm"]["email"].value;
	moblir=document.forms["updateForm"]["mobile"].value;
	bmonth=document.forms["updateForm"]["bmonth"].value;
	bday=document.forms["updateForm"]["bday"].value;
	dyear=document.forms["updateForm"]["byear"].value;
	cmpName=document.forms["updateForm"]["cmpName"].value;
	cmpID=document.forms["updateForm"]["cmpID"].value;
	branchName=document.forms["updateForm"]["branchName"].value;
	branchID=document.forms["updateForm"]["branchID"].value;
	...
	/*<tr><td>Photo</td><td><img src="images/defaultUserImage.png" height="100px" width="100px"/><br>
	   <input class="button" type="file" name="userImage"/></td></tr>*/
}
</script>
<body>
	...
	%>
	<div class="showContentTable" id="profile">
		<form name="updateForm" action="updateProfile.do" onsubmit="return checkValues()" method="post">
		<font size="4">		
			<table>
			<tr>
				<td>
					<fieldset><legend><font color="red" size=5>Profile</font></legend>
						...
						<tr><td colspan="2"><font color="red"><label id="registerText"></label></font></td></tr>
							...
							<tr><td><br>First Name</td><td><br><input type="text" name="fname" value=<%=fname %>></td></tr>
							<tr><td>Middle Name</td><td> <input type="text" name="mname" value=<%=mname %> ></td></tr>
							<tr><td>Last Name</td><td><input type="text" name="lname" value=<%=lname %> ></td></tr>
							<tr><td>Username</td><td><input type="text" name="uname" value=<%=rs.getString(4) %> disabled="disabled"></td></tr>
							<tr><td>Password</td><td><input type="text" name="pass" value=<%=rs.getString(5)%> disabled="disabled" ></td></tr>
							<tr><td>Re-Enter Password</td><td><input type="text" name="rpass" value=<%=rs.getString(5) %> disabled="disabled"></td></tr>
							<tr><td>E-Mail</td><td><input type="text" name="email" value=<%=rs.getString(6) %> ></td></tr>
							...
							<tr><td>Mobile Number</td><td><input type="text" name="mobile" value=<%=rs.getString(8) %>></td></tr>
							...
							<tr><td>Company Name</td><td><input type="text" name="cmpName" value=<%=rs.getString(10) %>></td></tr>
							<tr><td>Company ID</td><td><input type="text" name="cmpID" value=<%=rs.getString(11) %> ></td></tr>
							<tr><td>Branch Location Name</td><td><input type="text" name="branchName" value=<%=rs.getString(12) %>></td></tr>
							<tr><td>Branch Location ID</td><td><input type="text" name="branchID" value=<%=rs.getString(13) %>></td></tr>
							<tr><td colspan="2" align="center"><input class="button" type="submit" name="save" value="Update"></td></tr>
							</table>	
					</fieldset>
				</td>
			</tr>
